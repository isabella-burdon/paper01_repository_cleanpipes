...
pip install bs4 scipy pandas numpy pyarrow matplotlib nanoQC bokeh==2.3.3 
...
# mamba create -n parallelQC -y -c conda-forge -c bioconda parallel python pandas matplotlib numpy pytorch==2.2.0 torchvision -c pytorch-nightly
# conda install -n parallelQC pytorch::torchaudio
mamba create -n SeqIO -c conda-forge biopython
